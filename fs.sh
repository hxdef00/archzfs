...
zfs create -o canmount=off -o mountpoint=none bpool/$INST_ID/BOOT
zfs create -o canmount=off -o mountpoint=none rpool/$INST_ID/ROOT
zfs create -o canmount=off -o mountpoint=none rpool/$INST_ID/DATA
